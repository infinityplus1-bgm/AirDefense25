...
class TrackerTestNode(Node):
    def __init__(self):
        ...
        self.tracked_objects_subscription = message_filters.Subscriber(self , Float32MultiArray2D , '/tracked_objects' , qos_profile=qos_profile)
    ...
    def display_callback(self , image : Image , tracked_objects : Float32MultiArray2D):
        ...
        results : np.ndarray = np.array(tracked_objects , dtype=np.float32)
